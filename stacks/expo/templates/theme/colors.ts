// Color tokens — "Spec Sheet" language. Plain TS, no styling library. Import directly:
...
// maps: `colors` (night tone, the default) or `colorsLight` (paper tone). Every
// primitive must read correctly in both. Never pure #000 / #fff on a surface.
...
export const palette = {
  ...
  // Hairlines. Depth is a 1px line, never a shadow.
  lineOnDark: 'rgba(255, 255, 255, 0.08)',
  lineOnDarkStrong: 'rgba(255, 255, 255, 0.18)',
} as const;

/** Semantic token contract. Both tones implement it, so screens swap tone by map. */
...
export const colors: SemanticColors = {
  ...
  primaryPressed: palette.neutral200,
...
/** Paper tone — light screens. Same contract, inverted surfaces. */
export const colorsLight: SemanticColors = {
  ...
  primary: palette.ink,
  primaryPressed: palette.neutral800,
