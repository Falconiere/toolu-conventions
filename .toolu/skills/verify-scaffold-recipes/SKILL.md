...
3. Run unit tests, type checking, formatting, and the affected real-project eval. Use `bun test tests/evals/typescript-e2e.test.ts --test-name-pattern 'real console'` or `'real marketing'`; Rust runtime checks are in `tests/evals/rust-e2e.test.ts`.
